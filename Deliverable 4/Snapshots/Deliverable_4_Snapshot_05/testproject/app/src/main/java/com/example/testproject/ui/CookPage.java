...
public class CookPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cookBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String address = Cook_addy.getText().toString().trim();
                final String description = Cook_description.getText().toString().trim();
                ...
                authenticator.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            newCook(first, last, email, address, description,  complaint, user.getUid());
    ...
    private void newCook(String first, String last, String email, String address, String description, String complaint, String userID) {
        Cook cook = new Cook(first, last, email, address, description, complaint, "Active", 0.00);
