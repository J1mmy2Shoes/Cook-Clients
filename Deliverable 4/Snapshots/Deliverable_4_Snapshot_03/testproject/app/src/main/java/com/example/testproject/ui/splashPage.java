...
public class splashPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String id = DRef.push().getKey();
                ...
                databaseRefCooks.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        showMeal(meal.getId(),meal.getMealName(), meal.getMealType(),
                                ...
                                meal.getDescription(),
                                firstname + " " + lasttname, description, rating, email ,meal.getCook(),meal.isOffered());
    ...
    private void showMeal(final String id, String meal, String type, String cuisine,
                          ...
                          String desc, String name, String Cdescript, String rating, String email, final String CookID, final Boolean offered){
        ...
        purchaseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NewRequest(Meal_name, CookID, Client.getUid(), id);
    ...
    private void NewRequest(String Name, String CookId, String ClientId,String UserId){
            Request request = new Request(Name,CookId,ClientId);
